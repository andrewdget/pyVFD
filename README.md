...
This method is used to automaticaly display alpha-numeric characters. Alpha-numeric characters supported by ```.seg16()``` are A-Z (capital and lower-case) and 0-9 (see [Background](https://github.com/andrewdget/pyVFD/tree/development#background) section for more).
