...
This method is used to automatically display alpha-numeric characters. Alpha-numeric characters supported by ```.seg16()``` are A-Z (capital and lower-case) and 0-9 (see [Background](https://github.com/andrewdget/pyVFD/tree/main#background) section for more).
...
def change2nine():
	'''example function for resetting and updating pyVFD displays'''
